...
class CustomerDetailsResourceIT {
    ...
    private static final Integer DEFAULT_NUMBER_ADDRESS_LINE_1 = 0;
    private static final Integer UPDATED_NUMBER_ADDRESS_LINE_1 = 1;
    ...
    public static CustomerDetails createEntity(EntityManager em) {
        CustomerDetails customerDetails = new CustomerDetails()
            ...
            .numberAddressLine1(DEFAULT_NUMBER_ADDRESS_LINE_1)
    ...
    public static CustomerDetails createUpdatedEntity(EntityManager em) {
        CustomerDetails customerDetails = new CustomerDetails()
            ...
            .numberAddressLine1(UPDATED_NUMBER_ADDRESS_LINE_1)
    ...
    void createCustomerDetails() throws Exception {
        ...
        assertThat(testCustomerDetails.getNumberAddressLine1()).isEqualTo(DEFAULT_NUMBER_ADDRESS_LINE_1);
        ...
        assertThat(testCustomerDetails.getAge()).isEqualTo(DEFAULT_AGE);
    }
    ...
    void getAllCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            ...
            .andExpect(jsonPath("$.[*].numberAddressLine1").value(hasItem(DEFAULT_NUMBER_ADDRESS_LINE_1)))
    ...
    void getCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            ...
            .andExpect(jsonPath("$.numberAddressLine1").value(DEFAULT_NUMBER_ADDRESS_LINE_1))
    ...
    void putNewCustomerDetails() throws Exception {
        ...
        assertThat(testCustomerDetails.getNumberAddressLine1()).isEqualTo(UPDATED_NUMBER_ADDRESS_LINE_1);
        ...
        assertThat(testCustomerDetails.getAge()).isEqualTo(UPDATED_AGE);
    }
    ...
    void partialUpdateCustomerDetailsWithPatch() throws Exception {
        ...
        partialUpdatedCustomerDetails.phone(UPDATED_PHONE).addressLine1(UPDATED_ADDRESS_LINE_1).addressLine2(UPDATED_ADDRESS_LINE_2);
